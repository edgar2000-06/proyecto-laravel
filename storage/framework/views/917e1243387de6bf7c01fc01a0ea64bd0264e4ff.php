...
<ol class="breadcrumb">
    ...
    <li class=><a href="<?php echo e(route('vendedor.index')); ?>"><i class="fa fa-black-tie"></i> Vendedores</a></li>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <form method="POST" action="<?php echo e(route('vendedor.index')); ?>">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" name="cedula" value="<?php echo e(old('cedula')); ?>" id="cedula" class="form-control" placeholder="Ingresar cedula" required>
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="direccion" value="<?php echo e(old('direccion')); ?>" id="direccion" class="form-control" placeholder="Ingresar dirección" required>
                        </div>
                        
                        <div class="form-group col-md-6">
                            <label for="porc-com-ven">Porcentage de comisión de venta</label>
                            <input type="number" name="porc-com-ven" value="<?php echo e(old('porc-com-ven')); ?>" id="porc-com-ven" class="form-control" placeholder="Ingresar porcentage de comisión de venta" required>
                        </div>
                        
                        <div class="form-group col-md-6">
                            <label for="porc-com-cob">Porcentage de comisión de cobro</label>
                            <input type="number" name="porc-com-cob" value="<?php echo e(old('porc-com-cob')); ?>" id="porc-com-cob" class="form-control" placeholder="Ingresar porcentage de comisión de cobro" required>
                        </div>
