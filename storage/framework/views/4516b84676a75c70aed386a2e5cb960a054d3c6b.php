...
<div class="box box-primary">
    <div class="box-header">
        ...
        <?php if(auth()->user()->is_admin): ?>
            <a href="<?php echo e(route('segmento.create')); ?>" class="btn btn-primary pull-right">
            ...
            <tbody>
                <?php $__currentLoopData = $Segmentos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $segmento): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td>
                        <?php if(auth()->user()->is_admin): ?>
                            <a href="<?php echo e(route('segmento.edit', $segmento)); ?>"
                                class="btn btn-xs btn-info"
                            ><i class="fa fa-pencil"></i></a>
                            <form method="POST"
                                action="<?php echo e(route('segmento.destroy', $segmento)); ?>"
